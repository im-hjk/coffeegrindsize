...
application = defines.get('app', './dist/coffeegrindsize.app')
...
filename = "coffeegrindsize_{}_mac.dmg".format(get_version())

# Uncomment to override the output volume name
volume_name = 'coffeegrindsize install'
...
# copied to the image, *or* you can define badge_icon, in which case the
# icon file you specify will be used to badge the system's Removable
# Disk icon
#
...
try:
    background = os.path.join(os.environ['GITHUB'],
                              "coffeegrindsize",
                              "build_tools",
                              "DMG_background.jpg")
except KeyError:
