...
###############################################################################
#
# fix_heat_wxs.py: Support script for coffeegrindsize Windows installer build
#
###############################################################################
#
# This file contains a Python script to assist in the process of
# building a Windows Installer for the coffeegrindsize application.
#
...
# pyinstaller-generated coffeegrindsize executable generated in the "one
...
# running this script is in the coffeegrindsize/build_tools/README file in
...
#                         Name of output file
#                         (default=coffeegrindsize_<version>_win.wxs)
...
# Constants
MANUFACTURER = "Jonathan Gagne"
PRODUCT_NAME = "coffeegrindsize"
UPGRADE_CODE = "{0eb8d248-5968-4251-91cc-6771231274df}"
...
def get_version():
    try:
        ...
        print("*  e.g.:   set GITHUB=%HOME%\\Documents\\GitHub                *")
        print("*          setx GITHUB=%HOME%\\Documents\\GitHub               *")
        print("**************************************************************")
        raise
    try:
...
product_name_w_version = "coffeegrindsize " + version_from_file
default_outfile = "coffeegrindsize_" + version_from_file + "_win.wxs"
...
def add_product_icon():
    ...
    product_icon = soup.new_tag("Icon",
                                Id="ProductIcon",
                                SourceFile="coffeegrindsize.ico")
